...
class NumberCustomField extends StatefulWidget {
  const NumberCustomField({super.key, required this.field});
  final AppointmentFieldEntity field;

  @override
  State<NumberCustomField> createState() => _NumberCustomFieldState();
}

class _NumberCustomFieldState extends State<NumberCustomField> {
  @override
