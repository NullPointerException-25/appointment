...
class UserAuthRepositoryImpl extends GetxService implements UserAuthRepository{
  ...
  UserAuthRepositoryImpl({UserFirebaseAuthDatasource? firebaseAuthDatasource}){
    _firebaseAuthDatasource = firebaseAuthDatasource??UserFirebaseAuthDatasource.to;
  }
  @override
  ...
  Future<void> signUpWithEmailAndPassword(String email, String password) async {
     await _firebaseAuthDatasource.createUserWithEmailAndPassword(email, password);
  }
